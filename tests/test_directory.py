...
def test_directory_creation():
    ...
    BlobService(None, None, MOCK_BLOBS_DIRECTORY, MOCK_LINKS_DIRECTORY, 1, MOCK_PARTIAL_UPLOADS_DIRECTORY)
...
data = [
    # Same directory
    ((None, None, dir, dir, 1, dir), ValueError),
    ((None, None, dir*2, dir, 1, dir), ValueError),
    ((None, None, dir, dir*2, 1, dir), ValueError),
    ((None, None, dir, dir, 1, dir*2), ValueError),
    # Invalid data transfer size
    ((None, None, MOCK_BLOBS_DIRECTORY, MOCK_LINKS_DIRECTORY, 0, MOCK_PARTIAL_UPLOADS_DIRECTORY), ValueError),
    ((None, None, MOCK_BLOBS_DIRECTORY, MOCK_LINKS_DIRECTORY, 0.5, MOCK_PARTIAL_UPLOADS_DIRECTORY), TypeError),
    # Directory is not a string
    ((None, None, 1, MOCK_LINKS_DIRECTORY, 1, MOCK_PARTIAL_UPLOADS_DIRECTORY), TypeError),
    ((None, None, MOCK_BLOBS_DIRECTORY, 1, 1, MOCK_PARTIAL_UPLOADS_DIRECTORY), TypeError),
    ((None, None, MOCK_BLOBS_DIRECTORY, MOCK_LINKS_DIRECTORY, 1, 1), TypeError),
]
